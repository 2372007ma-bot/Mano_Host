...
طُوِّر بواسطة: ᗴᒪᗰOᗪᗰᗴᑎ | @M_Y_K_2
"""
...
# ========== إعدادات البوت ==========
BOT_TOKEN = "8883097783:AAEnuD9g18Vrany0owDQ9S1nQxcrkfgKmpc"
API_BASE_URL = os.environ.get("API_BASE_URL", "https://mero-host.onrender.com")

# إيدي الأدمن على تليجرام
ADMIN_TELEGRAM_IDS = [8232334193]

# معلومات المطور
DEVELOPER_INFO = "🛠 طُوِّر بواسطة: *MANO*\n📬 تواصل: @M_Y_K_2"
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, edit=False):
    ...
    keyboard.append([InlineKeyboardButton("💬 تواصل مع المطور @M_Y_K_2", url="https://t.me/M_Y_K_2")])
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("💬 تواصل مع المطور @M_Y_K_2", url="https://t.me/M_Y_K_2")],
    ]
...
async def handle_api_key(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result = api_request("/api/bot/verify", method="POST", data={"api_key": api_key})
    if not result or not result.get("success"):
        keyboard = [[InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/M_Y_K_2")]]
        await update.message.reply_text(
            "❌ *مفتاح API غير صالح!*\n\n"
            "تحقق من الكود وحاول مرة أخرى\n"
            "أو تواصل مع المطور: @M_Y_K_2",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(keyboard),
        )
        return WAITING_FOR_API_KEY
