#!/usr/bin/env python3
"""
𝙼𝙰𝙽𝙾 𝙷𝙾𝚂𝚃 - مشغّل بوت تليجرام
طُوِّر بواسطة: @M_Y_K_2
"""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "👋 مرحباً! أنا بوت يعمل على 𝙼𝙰𝙽𝙾 𝙷𝙾𝚂𝚃\n\n"
        "الأوامر المتاحة:\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "📚 المساعدة:\n\n"
        "هذا البوت يعمل بشكل مستمر على خادم 𝙼𝙰𝙽𝙾 𝙷𝙾𝚂𝚃\n"
        "للاشتراك أو الاستفسار: @M_Y_K_2"
    )
...
def run_bot(token: str, bot_name: str) -> None:
    try:
        print("\n" + "═"*60)
        print(f" 🤖 𝙼𝙰𝙽𝙾 𝙷𝙾𝚂𝚃 - جاري تشغيل البوت: {bot_name}")
        ...
        print(f" ✅ البوت {bot_name} جاهز الآن على 𝙼𝙰𝙽𝙾 𝙷𝙾𝚂𝚃!")
